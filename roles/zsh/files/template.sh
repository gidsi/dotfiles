...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg ffeeff # foreground
  printf $printf_template_custom Pi ffeeff # bold color
  printf $printf_template_custom Pj 331354 # selection color
  printf $printf_template_custom Pk ffeeff # selected text color
  printf $printf_template_custom Pl ffeeff # cursor
  printf $printf_template_custom Pm 1e0528 # cursor text
else
